...
class RecreateScene7AvailabilityAttr implements DataPatchInterface
{
    ...
    public function apply(): void
    {
        ...
        $eavSetup->removeAttribute(Product::ENTITY, 'scene7_available_image_angles');
    ...
    {
        return [CreateScene7AvailabilityAttr::class];
    }
