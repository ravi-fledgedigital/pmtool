...
namespace Seoulwebdesign\Toast\Ui\Component\Listing\Column;
...
{
    public const MESSAGE_URL_PATH_EDIT = 'seoulwebdesign_toast/message/edit';
    public const MESSAGE_URL_PATH_DELETE = 'seoulwebdesign_toast/message/delete';
