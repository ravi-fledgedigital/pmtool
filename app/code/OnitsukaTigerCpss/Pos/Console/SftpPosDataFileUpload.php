...
class SftpPosDataFileUpload extends Command
{
    ...
    protected function configure()
    {
        ...
        $this->setName('OT:cpss-sftp-pos-data-file-transfer');
        $this->setDescription('Cpss SFTP POS Data File Transfer');
    ...
    protected function execute(InputInterface $input, OutputInterface $output)
    {
        if ($storeCode = $input->getOption(self::STORE_CODE)) {
            ...
            $this->cpssTransferFiles->executeEc($storeCode, true);
