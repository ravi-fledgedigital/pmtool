...
class ConfigProviderDesktop implements ConfigProviderInterface
{
    /** @var LayoutInterface */
    protected $_layout;
    /**
    ...
    {
        return [
            'gift_packaging_block_desktop' => $this->cmsBlock,
            'is_checkbox_show_desktop' => $this->dataHelper->isGiftPackagingEnabled() ? $this->checkIsProductContainPrefix() : 'false',
            'is_gift_packaging_module_enabled' => $this->dataHelper->isGiftPackagingEnabled()
        ];
    }
