...
use Seoulwebdesign\KakaoSync\Model\CustomerAuthorize as CustomerAuthorizeModel;
use Seoulwebdesign\KakaoSync\Model\CustomerExtractor;
use Seoulwebdesign\KakaoSync\Service\Kakao;
use Magento\Framework\Controller\Result\RedirectFactory;

class CustomerAuthorize extends CustomerAuthorizeModel
{
    ...
    private \Magento\Framework\App\Response\RedirectInterface $redirectInterface;
    ...
    {
        $writer = new \Zend_Log_Writer_Stream(BP . '/var/log/customer_create_kakao.log');
        $logger = new \Zend_Log();
                ...
                if ($sessionEmail) {
                    ...
                    if (!$customerEmail) {
                        ...
                        if ($sessionEmail != $customerData['email']) {
                            ...
                            $logger->info("Kakao email : " . $customerData['email']);
