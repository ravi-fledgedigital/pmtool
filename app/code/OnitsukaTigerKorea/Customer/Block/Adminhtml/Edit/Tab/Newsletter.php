...
namespace OnitsukaTigerKorea\Customer\Block\Adminhtml\Edit\Tab;
...
class Newsletter extends \Magento\Customer\Block\Adminhtml\Edit\Tab\Newsletter
{
     ...
     * @return void
     */
    protected function prepareFormSingleWebsite(Fieldset $fieldset, array $subscriptions): void
    {
        ...
        $kakaoSubscriptionStatus = $customer->getCustomAttribute('subscribe_kakao') ?
            $customer->getCustomAttribute('subscribe_kakao')->getValue() : 0;

        $kakaoCheckboxElement = $fieldset->addField(
            'subscribe_kakao_',
            'checkbox',
            [
                'label' => __('Subscribed to Kakao'),
                'name' => 'customer[subscribe_kakao]',
                'data-form-part' => $this->getData('target_form'),
                'value' => $kakaoSubscriptionStatus,
                'checked' => $kakaoSubscriptionStatus,
                'onchange' => 'this.value = this.checked ? 1 : 0;',
            ]
        );

        $kakaoCheckboxElement->setIsChecked((bool)$kakaoSubscriptionStatus);
     ...
     * @return void
     */
    protected function prepareFormMultiplyWebsite(Fieldset $fieldset, array $subscriptions): void
    {
     ...
     */
    protected function getCurrentCustomer(): ?CustomerInterface
    {
     ...
     * @return array
     */
    protected function getCustomerSubscriptionsOnWebsites(): array
    {
        $customer = $this->getCurrentCustomer();
        if ($customer === null) {
            return [];
     ...
     * @return array
     */
    protected function retrieveSubscriberData(CustomerInterface $customer, int $websiteId): array
    {
     ...
     * @return bool
     */
    protected function isSingleWebsiteMode(): bool
    {
     ...
     * @return string
     */
    protected function getSubscriberStatusChangeDate(Subscriber $subscriber): string
    {
