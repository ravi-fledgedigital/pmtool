        ...
        try {
            ...
            if ($licenseValidity) {
                ...
                $result['message'] .= '<div class="license-pmsg invalid-license-pmsg">' .  __('The license key you entered is invalid.')
                    ...
                    . __('- Wrong domain name - check active license domain under My Downloadable Products section of your weltpixel.com account. License allows using the product on one Magento installation with any number of store views / URLs. Product can be installed on up to 5 sub-domains of the licensed domain for testing purpose, including domains .local | .localhost | .localdev | .dev | .development | .test | .staging | .stage | .ddev.site | .cloudwaysapps.com | magentosite.cloud | magento.cloud | nxcli.net | ddev.site | nxcli.io | magento2.docker  Ex: staging.domain.com, development.domain.com, domain.local, domain.dev etc..') . '<br/><br/>'
