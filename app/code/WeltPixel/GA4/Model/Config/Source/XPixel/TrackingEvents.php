...
namespace WeltPixel\GA4\Model\Config\Source\XPixel;
 ...
 *
 * @package WeltPixel\GA4\Model\Config\Source\XPixel
 */
    ...
    public function toOptionArray()
    {
        return array(
            ...
            array(
                ...
                'label' => __('ViewContent (Product)')
            ),
            array(
                'value' => self::EVENT_VIEW_CATEGORY,
                'label' => __('ViewContent (Category)')
            )
        );
    }
}
