        ...
        return Acstract.extend(general).extend(
            {
                defaults: {
                    ...
                    sourceOptions: null,
                    imports      : {
                        changeSource: '${$.parentName}.behavior_field_netsuite_attribute_map_entity:value'
                    },
                    ajaxUrl: '',
                },
                ...
                changeSource: function (value) {
                    ...
                    if (exists == 0) {
                        var parent = reg.get(this.ns +'.' + this.ns + '.behavior_field_netsuite_attribute_map_container.behavior_field_netsuite_attribute_map');
