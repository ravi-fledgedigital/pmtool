 ...
 */
class StockSourceQty extends AbstractAdapter
{
    /**
     * Adapter Data
     *
     ...
     * @param Gateway\StockSourceQty $gateway
    ...
    public function __construct(
        ...
        Gateway\StockSourceQty $gateway,
        $destination = null,
        array $data = []
    ) {
    ...
    public function writeRow(array $rowData)
    {
        ...
        $this->gateway->exportStockSourceQty($rowData);
