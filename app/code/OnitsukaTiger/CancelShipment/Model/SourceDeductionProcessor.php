...
class SourceDeductionProcessor
{
    ...
    /**
     * Deduct from inventory_source_item table and update inventory_reservation table
     *
    ...
    public function execute(ShipmentInterface $shipment): void
    {
        ...
        foreach ($shipmentItems as $item) {
            $items[] = $this->itemToDeduct->create([
                    'sku' => $item->getSku(),
                    'qty' => - $item->getQty()
            ]);
        }
        ...
        // Process source deduction for inventory_source_item table
