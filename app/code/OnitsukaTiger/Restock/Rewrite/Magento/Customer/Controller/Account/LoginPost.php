...
namespace OnitsukaTiger\Restock\Rewrite\Magento\Customer\Controller\Account;
...
class LoginPost extends \Magento\Customer\Controller\Account\LoginPost
{
    ...
    public function execute()
    {
        ...
        if ($this->getRequest()->isPost()) {
            ...
            if (isset($params['cusRedirectionUrl']) && 
                isset($params['autoAdd']) && 
                isset($params['productId']) && 
                !empty($params['cusRedirectionUrl']) && 
                !empty($params['autoAdd']) && 
            ...
            if (!empty($login['username']) && !empty($login['password'])) {
                try {
                    ...
                    if ($isRedirect) {
                        ...
                        $url = base64_decode($params['cusRedirectionUrl']) . "&autoAdd=" . base64_decode($params['autoAdd']) . "&productId=" . base64_decode($params['productId']);
