define([
    ...
    return Component.extend({
        defaults: {
            template: 'OnitsukaTiger_PortOne/payment/portone-samsungpay',
        ...
        afterPlaceOrder: function () {
            ...
            const config = window.checkoutConfig.payment.portonesamsungpay;
            ...
            $.ajax({
                ...
                if (orderInfo.success) {
                    ...
                    let paymentParams = {
                        ...
                        easyPay: {easyPayProvider: config.easyPayProvider}
                    };
