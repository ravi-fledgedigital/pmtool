...
class TossPayPayment extends AbstractMethod
{
    public const XML_PATH_IS_ENABLED = 'payment/portone_tosspay/active';

    protected $_code = 'portone_tosspay';
    ...
    public function capture(InfoInterface $payment, $amount)
    {
        ...
        $payment->addTransaction(
            ...
            null,
            false,
            'PortOne TossPay Payment Capture'
        );
    ...
    public function refund(\Magento\Payment\Model\InfoInterface $payment, $amount)
    {
        ...
        try {
            ...
            $payment->addTransaction(
                ...
                null,
                false,
                'Online refund via PortOne TossPay Payment'
            );
