...
class NPayPayment extends AbstractMethod
{
    public const XML_PATH_IS_ENABLED = 'payment/portone_npay/active';

    protected $_code = 'portone_npay';
    ...
    public function refund(\Magento\Payment\Model\InfoInterface $payment, $amount)
    {
        ...
        try {
            ...
            $payment->addTransaction(
                ...
                null,
                false,
                'Online refund via NPay Payment'
            );
