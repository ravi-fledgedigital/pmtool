...
class KakaoPayPayment extends AbstractMethod
{
    public const XML_PATH_IS_ENABLED = 'payment/portone_kakaopay/active';

    protected $_code = 'portone_kakaopay';
    ...
    public function capture(InfoInterface $payment, $amount)
    {
        ...
        $payment->addTransaction(
            ...
            null,
            false,
            'PortOne KakaoPay Payment Capture'
        );
    ...
    public function refund(\Magento\Payment\Model\InfoInterface $payment, $amount)
    {
        ...
        try {
            ...
            $payment->addTransaction(
                ...
                null,
                false,
                'Online refund via PortOne KakaoPay Payment'
            );
