...
class ApplePayPayment extends AbstractMethod
{
    public const XML_PATH_IS_ENABLED = 'payment/portoneapplepay/active';

    protected $_code = 'portoneapplepay';
    ...
    public function refund(\Magento\Payment\Model\InfoInterface $payment, $amount)
    {
        ...
        try {
            ...
            $payment->addTransaction(
                ...
                null,
                false,
                'Online refund via PortOne Apple pay'
            );
