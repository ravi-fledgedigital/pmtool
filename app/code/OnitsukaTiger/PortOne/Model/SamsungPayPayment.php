...
class SamsungPayPayment extends AbstractMethod
{
    public const XML_PATH_IS_ENABLED = 'payment/portonesamsungpay/active';

    protected $_code = 'portonesamsungpay';
    ...
    public function refund(\Magento\Payment\Model\InfoInterface $payment, $amount)
    {
        ...
        try {
            ...
            $payment->addTransaction(
                ...
                null,
                false,
                'Online refund via PortOne Samsung pay'
            );
