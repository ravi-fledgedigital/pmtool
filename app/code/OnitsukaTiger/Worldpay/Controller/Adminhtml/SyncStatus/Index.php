...
namespace OnitsukaTiger\Worldpay\Controller\Adminhtml\SyncStatus;
...
class Index extends \Sapient\Worldpay\Controller\Adminhtml\Syncstatus\Index
{
    ...
    )
    {
        ...
        parent::__construct($context, $resultJsonFactory, $wplogger, $paymentservice, $worldpaytoken, $orderservice, $storeManager, $abstractMethod, $helper);
    }
    ...
    private function _redirectBackToOrderView()
    {
        ...
        $resultRedirect->setPath('sales/order/view', ['order_id' => $this->_orderId]);
