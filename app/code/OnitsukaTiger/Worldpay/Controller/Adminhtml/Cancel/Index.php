...
namespace OnitsukaTiger\Worldpay\Controller\Adminhtml\Cancel;

use Magento\Backend\App\Action\Context;
use Magento\Framework\Controller\Result\JsonFactory;
use Exception;

class Index extends \Sapient\Worldpay\Controller\Adminhtml\Cancel\Index
{
    ...
    )
    {
        ...
        parent::__construct($context, $resultJsonFactory, $wplogger, $paymentservice, $worldpaytoken, $orderservice, $storeManager, $helper, $abstractMethod);
    }
