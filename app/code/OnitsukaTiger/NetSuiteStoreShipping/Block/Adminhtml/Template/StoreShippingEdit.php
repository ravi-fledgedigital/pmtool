<?php
namespace OnitsukaTiger\NetSuiteStoreShipping\Block\Adminhtml\Template;
 ...
 */
class StoreShippingEdit extends \Magento\Email\Block\Adminhtml\Template\Edit implements ContainerInterface
{
    /**
     * Template file
     *
    ...
    protected function _getDefaultTemplatesAsOptionsArray()
    {
        ...
        foreach ($options as $key => $option) {
            if ($option['value'] != '' && $option['group'] != 'Amasty_PDFCustom' && $option['group'] != 'OnitsukaTiger_NetSuiteStoreShipping') {
                unset($options[$key]);
            } else {
                continue;
            }
