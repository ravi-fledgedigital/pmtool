...
namespace OnitsukaTiger\NetSuiteStoreShipping\Ui\DataProvider;
    ...
    public function getData()
    {
        ...
        if (self::SOURCE_FORM_NAME === $this->name) {
            ...
            if ($data['totalRecords'] > 0) {
                ...
                $sourceRepository  = $this->sourceRepository->get($sourceCode);
                $sourceGeneralData['is_shipping_from_store'] = $sourceRepository->getIsShippingFromStore();
                $sourceGeneralData['exclude_skus_from_inventory_sync'] = $sourceRepository->getExcludeSkusFromInventorySync();
