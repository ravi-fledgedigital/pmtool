<?php
namespace OnitsukaTiger\InventorySourceAlgorithm\Controller\Adminhtml\SourceSelection;
 ...
 * @package OnitsukaTiger\InventorySourceAlgorithm\Controller\Adminhtml\SourceSelection
 */
class ProcessAlgorithm extends \Magento\InventoryShippingAdminUi\Controller\Adminhtml\SourceSelection\ProcessAlgorithm
{
    const ONESOURCE_ALGORITHM = 'onesource';
    const PRIORITY_ALGORITHM = 'priority';
    ...
    public function execute(): ResultInterface
    {
        ...
        if (!empty($postRequest['requestData'])) {
            ...
            if (($algorithmCode == self::ONESOURCE_ALGORITHM) && (!$sourceSelectionResult->isShippable())) {
                $sourceSelectionResult = $this->sourceSelectionService->execute($inventoryRequest, self::PRIORITY_ALGORITHM);
            }
