...
namespace OnitsukaTiger\CategoryModelImage\Block\Adminhtml\Product\Helper\Form;
...
class Gallery extends \Magento\Framework\View\Element\AbstractBlock
{
    ...
    public function getImages()
    {
        ...
        if($this->getDataObject()){
            $categoryId = $this->getDataObject()->getEntityId();
            if($categoryId){
                if($store = $this->getRequest()->getParam('store')){
                    $images = $this->imageGalleryCollection->getByCategoryIdStore($categoryId,$store);
                }else{
                    $images = $this->imageGalleryCollection->getByCategoryId($categoryId);
                }
            }
        }
        return $images;
