    ...
    function (
            ...
            rendererList.push(
                {
                    ...
                    component: 'OnitsukaTiger_Razer/js/view/payment/method-renderer/molpay_seamless_sandbox'
                }
            );
        }
        ...
        if ( config[molpayType].sandbox_environment == "0" ) {
            rendererList.push(
                {
                    type: payment_method_select,
                    component: 'OnitsukaTiger_Razer/js/view/payment/method-renderer/molpay_seamless'
                }
            );
        }
