...
namespace OnitsukaTiger\CustomStoreLocator\Ui\Component\Listing\Column;
...
class Thumbnail extends Column
{
    ...
    public function getImage($imagePath){
        if($imagePath!=""){
            return $this->storeManager->getStore()->getBaseUrl(UrlInterface::URL_TYPE_MEDIA).'/gallery/image/'.$imagePath;
        }
        return "";
    }
