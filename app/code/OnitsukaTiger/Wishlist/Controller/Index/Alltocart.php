 ...
 */
class Alltocart extends \Magento\Wishlist\Controller\AbstractIndex implements HttpPostActionInterface
{
    /**
     ...
     * @param OnitsukaTiger\Wishlist\Helper\Data $wishListHelper
    ...
    public function __construct(
        ...
        private \Magento\Wishlist\Model\ItemFactory $itemFactory,
        private \Magento\Wishlist\Model\Item\OptionFactory $optionFactory
    ) {
    ...
    public function execute()
    {
        ...
        $productComingSoon = $this->wishListHelper->isProductComingSoon($wishlistItems);
        if ($isPreOrderCartItem && !$wishListItemIsPreOrder) {
            ...
            $redirect->setPath('wishlist/index/index');
            return $redirect;
        } elseif($productComingSoon) {
            $this->messageManager->addErrorMessage(__('Some of the products are coming soon.'));
            $redirect = $this->resultFactory->create(\Magento\Framework\Controller\ResultFactory::TYPE_REDIRECT);
            $redirect->setPath('wishlist/index/index');
            return $redirect;
        }
