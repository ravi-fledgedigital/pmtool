...
class SourceDeductionWhenUpdateOrderInformationSuccess
{
    public const STOCK_POS_FLAG = 1;
    ...
    public function execute($shipment)
    {
        ...
        if (!$this->storeShipping->enabledModuleStoreShipping($shipment->getStoreId()) ||
