define([
    ...
    function setOptions(response) {
        if (response.error) {
            ...
            registry.get('otorderattribute_relation_form.otorderattribute_relation_form.general.attribute_options', function (input) {
                input.setOptions(response.attribute_options);
                input.clear();
            });
            registry.get('otorderattribute_relation_form.otorderattribute_relation_form.general.dependent_attributes', function (input) {
