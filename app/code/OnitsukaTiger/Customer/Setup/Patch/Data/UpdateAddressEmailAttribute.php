 ...
 */
class UpdateAddressEmailAttribute implements DataPatchInterface
{
    /**
     * @var Config
     */
    ...
    public function apply()
    {
        ...
        $eavSetup->removeAttribute('customer_address', 'email');
        $eavSetup->removeAttribute('customer_address', 'address_type');


        $eavSetup->addAttribute('customer_address', 'customer_address_type', [
            'type'             => 'int',
            'input'            => 'select',
            'label'            => 'Address Type',
            'visible'          => true,
        ...
        $customAttribute = $this->eavConfig->getAttribute('customer_address', 'customer_address_type');
