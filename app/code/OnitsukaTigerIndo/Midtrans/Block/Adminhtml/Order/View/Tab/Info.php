...
namespace OnitsukaTigerIndo\Midtrans\Block\Adminhtml\Order\View\Tab;

class Info extends \Midtrans\Snap\Block\Adminhtml\Order\View\Tab\Info
{
    /**
    ...
    private function getTableInfoTemplate(array $param)
    {
        ...
        if (array_key_exists('payment_method', $param)) {
