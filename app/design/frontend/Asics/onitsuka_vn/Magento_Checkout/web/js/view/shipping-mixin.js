    ...
    selectBillingAddress
        ...
        var mixin = {
            ...
            addressPopup: function () {
                ...
                $('#opc-new-shipping-address').find('[name="region"]').val('Vietnam').trigger('change');
                $('#opc-new-shipping-address').find('[name="city"]').val('Vietnam').trigger('change');
            },
            createNewAddress: function () {
                $('.form-shipping-address select[name="country_id"]').val(window.defaultCountry).trigger('change');
                var self = this;
                this.source.set('params.invalid', false);
                this.triggerShippingDataValidateEvent();
                var checkErrorCharaterAddress = $("#shipping-new-address-form input[name='validations-address-character']").parent().find('.field-error');
