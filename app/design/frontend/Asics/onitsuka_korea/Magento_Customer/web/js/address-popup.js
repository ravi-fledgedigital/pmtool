...
define([
    ...
    $.widget('mage.addressPopup', {
            ...
            if(self.options.deleteUrlPrefix){
                ...
                $.ajax({
                    ...
                    success: function (res) {
                        if(res.success){
                            $('.block-address-grid-container').replaceWith(res.address);
        ...
        initModal: function () {
            ...
            $('.form-address-edit-popup input#street_1, .form-address-edit-popup input#zip').attr('readonly','readonly');
        },
        /**
         * init Address Popup Modal
         */
        ...
        _bindAddress: function (id) {
            ...
            self.element.find('div.mage-error').remove();
        },
        /**
         *
         * @private
        ...
        disableButtonEdit: function () {
            var buttonEditSelector = $('.address-actions .edit');
            buttonEditSelector.contextmenu(function (e) {
                e.preventDefault();
            });
            buttonEditSelector.on("auxclick", function (e) {
                if (e.which === 2) {
                    e.preventDefault();
                }
            });
