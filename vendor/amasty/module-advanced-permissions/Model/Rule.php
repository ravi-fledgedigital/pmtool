...
use Amasty\Rolepermissions\Api\Data\RuleExtensionInterface;
...
class Rule extends AbstractExtensibleModel implements RuleInterface
{
     ...
     * @var string
     */
    protected $_eventPrefix = 'amasty_rolepermissions_rule';
    ...
    public function __construct(
        ...
        $extensionFactory ??= ObjectManager::getInstance()->get(ExtensionAttributesFactory::class);
        $customAttributeFactory ??= ObjectManager::getInstance()->get(AttributeValueFactory::class);
    ...
    public function setExtensionAttributes(
        ?RuleExtensionInterface $extensionAttributes = null
    ): RuleInterface {
