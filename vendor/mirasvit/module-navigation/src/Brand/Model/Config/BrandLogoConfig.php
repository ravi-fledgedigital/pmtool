...
class BrandLogoConfig extends BaseConfig
{
    ...
    public function isProductListBrandNameEnabled(): bool
    {
        return (bool)$this->scopeConfig->getValue(
            'brand/brand_logo/isProductListBrandNameEnabled',
            ScopeInterface::SCOPE_STORE,
            $this->storeId
        );
    }

    public function isProductPageBrandNameLinkEnabled(): bool
    {
        return (bool)$this->scopeConfig->getValue(
            'brand/brand_logo/isProductPageBrandNameLinkEnabled',
            ScopeInterface::SCOPE_STORE,
            $this->storeId
        );
    }
