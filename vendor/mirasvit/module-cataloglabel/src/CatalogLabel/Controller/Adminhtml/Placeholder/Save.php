...
class Save extends Placeholder
{
    ...
    public function execute()
    {
        ...
        if ($data = $this->getRequest()->getParams()) {
            ...
            if (!$model->getData('placeholder_id')) {
                $model->unsetData('placeholder_id');
            }

            try {
                $model->save();

                $this->messageManager->addSuccess((string)__('Placeholder was successfully saved'));
        ...
        $this->messageManager->addError((string)__('Unable to find a placeholder to save'));
        $this->_redirect('*/*/');
    }
