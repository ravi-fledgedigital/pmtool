...
class PinToTop implements ResolverInterface
{
    ...
    public function resolve(Field $field, $context, ResolveInfo $info, ?array $value = null, ?array $args = null): ?bool
    {
        ...
        $pinnedCategoryIds = $this->pinnedProductService->getCategoryIds((int)$value['entity_id']);

        return in_array($categoryId, $pinnedCategoryIds, true);
    }
}
