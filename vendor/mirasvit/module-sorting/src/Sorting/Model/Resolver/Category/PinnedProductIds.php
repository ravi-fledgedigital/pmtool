...
namespace Mirasvit\Sorting\Model\Resolver\Category;
...
class PinnedProductIds implements ResolverInterface
{
    ...
    public function resolve(Field $field, $context, ResolveInfo $info, ?array $value = null, ?array $args = null): array
    {
        ...
        return $this->pinnedProductService->getProductIds((int)$value['id']);
    }
}
