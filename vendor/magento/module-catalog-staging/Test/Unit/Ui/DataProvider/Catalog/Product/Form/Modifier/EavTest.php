...
class EavTest extends TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $wysiwygConfigProcessor = $this->getMockBuilder(CompositeConfigProcessor::class)
            ->disableOriginalConstructor()
            ->getMock();
        $scopeConfig = $this->getMockBuilder(ScopeConfigInterface::class)
            ->disableOriginalConstructor()
            ->getMock();
        $attributeCollectionFactory = $this->getMockBuilder(AttributeCollectionFactory::class)
            ->disableOriginalConstructor()
            ->getMock();
