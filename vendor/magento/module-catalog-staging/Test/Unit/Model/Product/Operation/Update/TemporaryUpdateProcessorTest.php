...
class TemporaryUpdateProcessorTest extends TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->versionHistory = $this->getMockForAbstractClass(
    ...
    public function testProcess()
    {
        ...
        $this->versionManagerMock->expects($this->atLeastOnce())->method('setCurrentVersionId')
            ->willReturnCallback(function ($arg1) use ($previousVersion, $rollbackId, $versionId) {
                if ($arg1 == $previousVersion || $arg1 == $rollbackId || $arg1 == $versionId) {
                    return null;
                }
            });
