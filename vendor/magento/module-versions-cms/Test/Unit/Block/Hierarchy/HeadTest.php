...
class HeadTest extends TestCase
{
     ...
     */
    public function testPrepareLayoutMetaDataEnabledAndNodeExistsShouldAddRemotePageAssets(): void
    {
        ...
        $this->pageConfig
            ...
            ->willReturnCallback(function (
                ...
                if ($arg1 == $chapterUrl && $arg2 == '' &&
                    $arg3 == ['attributes' => ['rel' => Node::META_NODE_TYPE_CHAPTER]]) {
                    return $this->pageConfig;
                } elseif ($arg1 == $sectionUrl && $arg2 == '' &&
                    $arg3 == ['attributes' => ['rel' => Node::META_NODE_TYPE_SECTION]]) {
                    return $this->pageConfig;
                } elseif ($arg1 == $nextUrl && $arg2 == '' &&
                    $arg3 == ['attributes' => ['rel' => Node::META_NODE_TYPE_NEXT]]) {
                    return $this->pageConfig;
                } elseif ($arg1 == $prevUrl && $arg2 == '' &&
                    $arg3 == ['attributes' => ['rel' => Node::META_NODE_TYPE_PREVIOUS]]) {
                    return $this->pageConfig;
                } elseif ($arg1 == $firstUrl && $arg2 == '' &&
                    $arg3 === ['attributes' => ['rel' => Node::META_NODE_TYPE_FIRST]]) {
                    return $this->pageConfig;
                }
            });
