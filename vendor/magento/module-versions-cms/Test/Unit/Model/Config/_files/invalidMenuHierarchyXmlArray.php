...
return [
    'page_layout_handle_must_be_unique' => [
        ...
        [
            ...
            "1:<config><menuLayout name=\"name_one\"><pageLayout handle=\"node_one_two\"/><pageLayout " .
            "handle=\"node_one_two\"/></menuLayout></config>\n2:\n"
        ],
    ],
    'menu_layout_name_must_be_unique' => [
        ...
        [
            ...
            "<menuLayout name=\"name_one\"/><menuLayout name=\"name_one\"/></config>\n2:\n"
        ],
    ],
    ...
    'handle_is_required_attribute' => [
        ...
        [
            ...
            "0:<?xml version=\"1.0\"?>\n1:<config><menuLayout name=\"name_one\"><pageLayout/>" .
            "</menuLayout></config>\n2:\n"
        ],
    ],
    'handle_with_required_name' => [
        ...
        '</config>',
        [
            "Element 'pageLayout', attribute 'handle': [facet 'pattern'] The value 'node(123)' is not accepted by " .
            "the pattern '[1-9A-Za-z_\-]+'.\nLine: 1\nThe xml was: \n0:<?xml version=\"1.0\"?>\n" .
            "1:<config><menuLayout name=\"name_one\"><pageLayout handle=\"node(123)\"/></menuLayout></config>\n2:\n"
        ],
    ],
