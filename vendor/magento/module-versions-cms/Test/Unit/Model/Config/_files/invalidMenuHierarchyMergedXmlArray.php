...
return [
    'page_layout_handle_must_be_unique' => [
        ...
        [
            ...
            "name=\"name_one\" label=\"One\" handle=\"handle_name\"><pageLayout handle=\"node_one_two\"/>" .
    ...
    'menu_layout_name_must_be_unique' => [
        ...
        [
            ...
            "<menuLayout name=\"name_one\" label=\"One\" handle=\"handle_name\"/><menuLayout name=\"name_one\" " .
            "label=\"One\" handle=\"handle_name\"/></config>\n2:\n"
        ],
    ],
    'name_is_required_attribute' => [
        ...
        [
            ...
            "0:<?xml version=\"1.0\"?>\n1:<config><menuLayout label=\"One\" handle=\"handle_name\"/></config>\n2:\n"
        ],
    ],
    'handle_is_required_attribute' => [
        ...
        [
            ...
            "0:<?xml version=\"1.0\"?>\n1:<config><menuLayout name=\"name_one\" label=\"One\" " .
            "handle=\"handle_name\"><pageLayout/></menuLayout></config>\n2:\n"
        ],
    ],
    'handle_with_not_required_name' => [
        ...
        [
            "Element 'pageLayout', attribute 'handle': [facet 'pattern'] The value 'node(12)' is not accepted " .
            "by the pattern '[1-9A-Za-z_\-]+'.\nLine: 1\nThe xml was: \n0:<?xml version=\"1.0\"?>\n" .
            "1:<config><menuLayout name=\"name_one\" label=\"One\" handle=\"handle_name\"><pageLayout " .
            "handle=\"node(12)\"/></menuLayout></config>\n2:\n"
        ],
    ],
    'optional_attributes_with_invalid_names' => [
        ...
        '</config>',
        [
            "Element 'menuLayout', attribute 'handle': [facet 'pattern'] The value 'handle(123)' is not " .
            "accepted by the pattern '[1-9A-Za-z_\-]+'.\nLine: 1\nThe xml was: \n0:<?xml version=\"1.0\"?>\n" .
            "1:<config><menuLayout name=\"name_one\" label=\"label12\" handle=\"handle(123)\" " .
            "isDefault=\"12\"/></config>\n2:\n"
        ],
    ],
    'menuLayout_has_required_attribute_label' => [
        ...
        [
            ...
            "0:<?xml version=\"1.0\"?>\n1:<config><menuLayout name=\"name_one\" handle=\"handle_one\"/>" .
            "</config>\n2:\n"
        ],
    ],
    'menuLayout_has_required_attribute_handle' => [
        ...
        [
            ...
            "0:<?xml version=\"1.0\"?>\n1:<config><menuLayout name=\"name_one\" label=\"handle123\"/></config>\n2:\n"
        ],
    ]
];
