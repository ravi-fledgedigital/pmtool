...
use Magento\VersionsCms\Model\ResourceModel\Hierarchy\Node\Collection as HierarchyNodeCollection;
use PHPUnit\Framework\MockObject\MockObject;
use PHPUnit\Framework\TestCase;

class NodeTest extends TestCase implements TestProvidesServiceInterface
{
    /**
     * @var Node
     */
    ...
    {
        if (HierarchyNodeCollection::class == $type) {
            return $this->abstractCollectionMock;
        }
        return null;
    }
    ...
    public function testAppendPageToNodes($storeIds, $setScopeCallTimes, $setScopeIdCallTimes)
    {
        $node = $this->getMockBuilder(Node::class)
            ->addMethods(['getPageExists', 'setParentNodeId'])
            ->onlyMethods([
                'getId', 'getLevel',
                'getRequestUrl', 'getXpath', 'setScope', 'setScopeId',
                'addData', 'unsetData', 'setLevel',
        ...
        $page = $this->getMockBuilder(Page::class)
            ->onlyMethods(['getStores', 'getId', 'getIdentifier'])
            ->disableOriginalConstructor()
            ->getMock();
