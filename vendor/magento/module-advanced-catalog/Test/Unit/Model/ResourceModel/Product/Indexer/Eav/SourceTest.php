...
class SourceTest extends TestCase
{
     ...
     */
    protected $attributeRepositoryInterfaceMock;
    ...
    protected function setUp(): void
    {
        ...
        $this->attributeRepositoryInterfaceMock = $this->createMock(AttributeRepositoryInterface::class);
        ...
        $this->_source = new Source(
            ...
            $this->helperMock,
            $connectionName,
            $this->attributeRepositoryInterfaceMock,
