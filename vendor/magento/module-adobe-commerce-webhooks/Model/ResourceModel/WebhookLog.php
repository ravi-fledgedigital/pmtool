...
namespace Magento\AdobeCommerceWebhooks\Model\ResourceModel;
...
/**
 * Webhook log resource model.
 */
class WebhookLog extends AbstractDb
{
    public const TABLE_NAME = 'webhooks_log';
    ...
    {
        $this->_init(self::TABLE_NAME, WebhookLogInterface::FIELD_ID);
    }
