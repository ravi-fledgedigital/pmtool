...
/**
 * Verifies that checked value is not matching value from the rule.
 */
class NotEqualOperator implements OperatorInterface
{
     ...
     */
    public function __construct(private EqualOperator $equalOperator)
    {
    }
     ...
     * Verifies that checked value is not matching value from the rule.
     *
     * Inverse the value of equal operator
     *
    ...
    {
        return !$this->equalOperator->verify($fieldValue, $ruleValue);
    }
}
