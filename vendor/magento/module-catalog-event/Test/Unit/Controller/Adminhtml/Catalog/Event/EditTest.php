...
class EditTest extends AbstractEventTest
{
    ...
    protected function setUp(): void
    {
        ...
        $this->sessionMock = $this->getMockBuilder(Session::class)
            ->addMethods(['setIsUrlNotice','getEventData'])
            ->disableOriginalConstructor()
            ->getMock();
    ...
    public function testExecute($eventId, $prepend, $dateEnd, $dateStart, $modifiedDateEnd, $modifiedDateStart)
    {
        $eventMock = $this->getMockBuilder(Event::class)
            ->addMethods(['getDateEnd', 'getDateStart', 'setDateEnd', 'setDateStart'])
            ->onlyMethods(['setStoreId', 'getId', 'load'])
            ->disableOriginalConstructor()
            ->getMock();
        $eventMock
            ->expects($this->any())
        ...
        $titleMock
            ...
            ->method('prepend')
            ->willReturnCallback(function ($arg) use ($prepend) {
