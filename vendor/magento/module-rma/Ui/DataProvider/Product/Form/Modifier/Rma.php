...
{
    public const FIELD_IS_RMA_ENABLED = 'is_returnable';
    ...
    public function modifyData(array $data)
    {
        ...
        if ($isUseDefaultChecked || !$modelId) {
            ...
            $isEnabled = (string) (int) $this->scopeConfig->isSetFlag(
                RmaProductSource::XML_PATH_PRODUCTS_ALLOWED,
                ScopeInterface::SCOPE_STORE,
                $this->locator->getStore()->getCode()
            );
            $data[$modelId][self::DATA_SOURCE_DEFAULT][self::FIELD_IS_RMA_ENABLED] = $isEnabled;
        }
