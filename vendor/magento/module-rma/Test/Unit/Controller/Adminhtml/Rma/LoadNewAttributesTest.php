...
class LoadNewAttributesTest extends RmaTest
{
    ...
    public function testLoadNewAttributesActionWithoutUserAttributes(): void
    {
        ...
        $this->requestMock
            ->method('getParam')
            ->willReturnCallback(function ($arg1, $arg2 = null) use ($productId, $itemId) {
                if ($arg1 === 'product_id') {
                    return $productId;
                } elseif ($arg2 === 'item_id') {
                    return $itemId;
    ...
    public function testLoadNewAttributeActionResponseArray(): void
    {
        ...
        $this->requestMock
            ->method('getParam')
            ->willReturnCallback(function ($param1, $param2) use ($productId, $itemId) {
                if ($param1 === 'product_id' && $param2 === null) {
                    return $productId;
                } elseif ($param1 === 'item_id') {
                    return $itemId;
                }
            });
        $this->objectManagerMock->expects($this->once())
