...
class ConfigTest extends TestCase
{
    ...
    public function testGetCustomerEmailRecipient(): void
    {
        ...
        $this->scopeConfig
            ->method('getValue')
            ->willReturnCallback(function ($arg1, $arg2, $arg3) use ($senderCode, $data) {
                if ($arg1 == Config::XML_PATH_CUSTOMER_COMMENT_EMAIL_RECIPIENT &&
                    $arg2 == ScopeInterface::SCOPE_STORE &&
                    $arg3 == null) {
                    return $senderCode;
                } elseif ($arg1 == 'trans_email/ident_' . $senderCode . '/email' &&
                    $arg2 == ScopeInterface::SCOPE_STORE &&
                    $arg3 == null) {
                    return $data;
                }
