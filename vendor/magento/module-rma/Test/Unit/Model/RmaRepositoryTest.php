...
class RmaRepositoryTest extends TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $objects = [
            [
                RmaResourceInterface::class,
                $this->createMock(RmaResourceInterface::class)
            ],
            [
                RmaSearchResultInterfaceFactory::class,
                $this->createMock(RmaSearchResultInterfaceFactory::class)
            ]
        ];
