...
class DaysAgoTest extends TestCase
{
        ...
        if ($startOperator != 'eq') {
            ...
            $this->localeDate
                ...
                ->willReturnCallback(fn($param) => match ([$param]) {
                    [$date->format('Y-m-d 00:00:00')] => 'convertConfigTimeToUtcResultStartDate',
                    [$date->format('Y-m-d 23:59:59')] => 'convertConfigTimeToUtcResultEndDate'
                });
     ...
     * @return array
     */
    public static function applyToCollectionDataProvider(): array
    {
        return [
