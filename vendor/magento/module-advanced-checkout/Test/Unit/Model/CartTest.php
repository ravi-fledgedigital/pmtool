...
class CartTest extends TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->searchCriteriaBuilder = $this->getMockBuilder(SearchCriteriaBuilder::class)
            ->disableOriginalConstructor()
            ->getMock();
        $isProductInStock = $this->getMockBuilder(IsProductInStockInterface::class)
            ->disableOriginalConstructor()
            ->getMock();
        $areProductsSalableForRequestedQty = $this->getMockBuilder(AreProductsSalableForRequestedQtyInterface::class)
            ->disableOriginalConstructor()
            ->getMock();
    ...
    public function testGetValidatedItemWithConfig()
    {
        ...
        $productMock = $this->getMockBuilder(Product::class)
            ->disableOriginalConstructor()
            ->onlyMethods(['getId', 'getWebsiteIds', 'isComposite'])
            ->getMock();
