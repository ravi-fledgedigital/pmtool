...
{
    /**
     * Core registry instance for managing temporary variables.
     *
    ...
    protected function _prepareLayout()
    {
        ...
        $deleteAllConfirmString = $this->escapeJs(
            $this->escapeHtml(__('Are you sure you want to clear your cart?'))
        );
        $this->addChild(
    ...
    /**
     * Get order data JSON for frontend consumption.
     *
     * @return string
     */
