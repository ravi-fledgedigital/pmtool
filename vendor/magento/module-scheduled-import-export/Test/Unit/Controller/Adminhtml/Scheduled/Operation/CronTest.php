...
class CronTest extends TestCase
{
    ...
    public function testCronActionFrontendAreaIsSetToDesignBeforeProcessOperation(): void
    {
        ...
        $design
            ...
            ->willReturnCallback(function ($arg1, $arg2) use ($design) {
                if ($arg1 == Area::AREA_FRONTEND || $arg2 == 'adminhtml') {
                    return $design;
                }
            });
        ...
        $objectManagerMock
            ...
            ->willReturnCallback(fn($param) => match ([$param]) {
                [DesignInterface::class] => $design,
                [Observer::class] => $observer,
                [ProcessingErrorAggregatorInterface::class] => $errorAggregator
            });
