...
{
    public const GROUP_GIFTCARD = 'giftcard-information';
    public const CONTAINER_OPEN_AMOUNT_RANGE = 'open_amount_range';
    public const FIELD_CONFIG_PREFIX = 'use_config_';
    public const FIELD_GIFTCARD_TYPE = 'giftcard_type';
    public const FIELD_GIFTCARD_AMOUNTS = 'giftcard_amounts';
    public const FIELD_WEBSITE_ID = 'website_id';
    public const FIELD_VALUE = 'value';
    public const FIELD_DELETE = 'delete';
    public const FIELD_ALLOW_OPEN_AMOUNT = 'allow_open_amount';
    public const FIELD_OPEN_AMOUNT_MIN = 'open_amount_min';
    public const FIELD_OPEN_AMOUNT_MAX = 'open_amount_max';
    public const FIELD_IS_REDEEMABLE = 'is_redeemable';
    public const FIELD_LIFETIME = 'lifetime';
    public const FIELD_ALLOW_MESSAGE = 'allow_message';
