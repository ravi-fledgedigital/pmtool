...
/**
 * Validates the hook method name
 */
class HookMethodValidator implements HookDataValidatorInterface
{
    /**
     * Validates that webhook method contains only alphanumeric characters, underscores and dots
     *
    ...
    {
        if (!preg_match('/^[A-Za-z0-9_\.]+$/', $hook->getWebhookMethod())) {
