...
class CustomerPluginTest extends TestCase
{
    ...
    public function testBeforeBeforeSaveSetsRewardRelatedAttributesFromRequestForExistingCustomer()
    {
        ...
        $customerMock->expects($this->exactly(2))->method('setData')
            ->willReturnCallback(function ($arg1, $arg2) use ($customerMock) {
                if ($arg1 === 'reward_update_notification' && $arg2 === 1) {
                    return $customerMock;
                } elseif ($arg1 === 'reward_warning_notification' && $arg2 === 0) {
                    return $customerMock;
                }
            });
