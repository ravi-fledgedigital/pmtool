...
namespace Magento\SaaSCategory\Setup\Patch\Schema;
...
class DropSubmittedHashTables implements SchemaPatchInterface
{
    ...
    public function apply(): self
    {
        ...
        $submittedHashTable = 'catalog_category_data_submitted_hash';
        $connection = $this->schemaSetup->getConnection();
        $tableName = $this->schemaSetup->getTable($submittedHashTable);
