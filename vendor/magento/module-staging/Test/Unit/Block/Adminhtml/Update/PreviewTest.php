...
class PreviewTest extends TestCase
{
    ...
    public function testGetStoreSelectorOptionsForDifferentStoreViews(array $storeViews, array $expectedResult): void
    {
        $websiteMock = $this->getMockBuilder(Website::class)->disableOriginalConstructor()
            ->onlyMethods(['getGroups', 'getId', 'getName'])->getMock();
        $groupMock = $this->getMockBuilder(Group::class)
            ->disableOriginalConstructor()
            ->onlyMethods(['getStores', 'getName'])
            ->getMock();
    ...
    {
        $enabledStoreView = $this->getMockBuilder(Store::class)->disableOriginalConstructor()
            ->onlyMethods(['isActive', 'getName', 'getCode', 'getBaseUrl'])
            ->getMock();
