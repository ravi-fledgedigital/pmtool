...
class UpdateTest extends TestCase
{
    ...
    public function testExecute($arguments = [], $entityData = []): void
    {
        ...
        $originId = $arguments['origin_in'] ?? null;
        ...
        if ($originId) {
            $this->rescheduleUpdate->expects($this->once())
                ->method('reschedule')
                ->with($originId, $arguments['created_in'], $this->entity)
                ->willReturn($versionInfo);
        ...
        $this->eventManager
            ->method('dispatch')
            ->willReturnCallback(function ($arg1, $arg2) use ($entityType) {
                if ($arg1 == 'entity_save_before' &&
                    $arg2 == ['entity_type' => $entityType, 'entity' => $this->entity]) {
                     return null;
                } elseif ($arg1 == 'entity_manager_save_after' &&
                    $arg2 == ['entity_type' => $entityType, 'entity' => $this->entity]) {
                    return null;
                }
            });
        $this->eventManager
            ...
            ->willReturnCallback(function ($arg1, $arg2, $arg3) use ($entityType) {
                if ($arg1 == $entityType &&
                    $arg2 == 'save_before' && $arg3 == ['entity' => $this->entity]) {
                    return null;
                } elseif ($arg1 == $entityType &&
                    $arg2 == 'save_before' && $arg3 == ['entity' => $this->entity]) {
                    return null;
                }
            });
    ...
    public static function updateDataProvider(): array
    {
        return [
            ...
            'testExecuteToSetCurrentVersionId' => [
                'arguments' => [
                    'origin_in' => '1464685260',
                    'created_in' => '1464685261',
                    'store_id' => '0',
                ],
                'entityData' => [
                    'id' => 1,
