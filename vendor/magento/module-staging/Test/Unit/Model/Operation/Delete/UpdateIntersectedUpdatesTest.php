...
class UpdateIntersectedUpdatesTest extends TestCase
{
    ...
    public function testExecuteTemporaryUpdate(): void
    {
        ...
        $selectMock
            ->method('where')
            ->willReturnCallback(function ($arg1, $arg2) use ($selectMock, $entityId, $nextVersionId) {
                if ($arg1 == 'created_in = ?' && $arg2 == $nextVersionId) {
                    return $selectMock;
                } elseif ($arg1 == $entityId . ' = ?' && $arg2 == $this->entityMock[$entityId]) {
                    return $selectMock;
                }
            });
