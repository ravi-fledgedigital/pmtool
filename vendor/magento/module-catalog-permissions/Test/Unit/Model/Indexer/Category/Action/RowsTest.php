...
class RowsTest extends TestCase
{
    ...
    public function testExecute(): void
    {
        ...
        $this->connectionMock
            ->method('delete')
            ->willReturnCallback(function ($table, $condition) {
                if ($table == AbstractAction::INDEX_TABLE &&
                    $condition == 'customer_group_id IN (3,4) AND category_id IN (1,2)') {
                    return null;
                } elseif ($table == AbstractAction::INDEX_TABLE . '_product' &&
                    $condition == 'customer_group_id IN (3,4) AND product_id IN (1,2)') {
                    return null;
                }
            });
