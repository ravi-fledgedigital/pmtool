...
class ArchiveDataProviderTest extends TestCase
{
     ...
     */
    public const DEFAULT_DATA_PROVIDER = 'default_data_provider';

    /**
     * Value for archive DataProvider
     */
    public const ARCHIVE_DATA_PROVIDER = 'archive_data_provider';
    ...
    public function testGetSearchCriteria($isOrderInArchive, $setRequestNameCount, array $setRequestNameValues)
    {
        ...
        $this->searchCriteriaMock->expects($this->exactly($setRequestNameCount))
            ...
            ->willReturnCallback(function (...$setRequestNameValues) {
                if ($setRequestNameValues) {
                    return null;
                }
            });
    ...
    public static function getSearchCriteriaDataProvider()
    {
        return [
            'Order in Archive' => [
                ...
                'setRequestNameValues' => [
                    [self::equalTo(self::DEFAULT_DATA_PROVIDER)],
                    [self::equalTo(self::ARCHIVE_DATA_PROVIDER)]
                ]
            ],
