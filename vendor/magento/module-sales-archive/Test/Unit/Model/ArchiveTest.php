...
class ArchiveTest extends TestCase
{
    ...
    public function testArchiveOrdersException(): void
    {
        ...
        $this->resourceArchive
            ->method('moveToArchive')
            ->willReturnCallback(function ($arg1, $arg2, $arg3) use ($entity, $ids) {
                if ($arg1 == ArchivalList::ORDER && $arg2 == $entity && $arg3 == $ids) {
                    throw new \Exception();
                }
            });
    ...
    public function testRemoveOrdersFromArchive(): void
    {
        ...
        $this->resourceArchive
            ...
            ->willReturnCallback(function ($arg1) {
                if ($arg1 == ArchivalList::ORDER) {
                    return $this->resourceArchive;
                } elseif ($arg1 == ArchivalList::INVOICE) {
                    return $this->resourceArchive;
                } elseif ($arg1 == ArchivalList::SHIPMENT) {
                    return $this->resourceArchive;
                } elseif ($arg1 == ArchivalList::CREDITMEMO) {
                    return $this->resourceArchive;
                }
            });
        $this->resourceArchive
