 ...
 */
class RequestProxy extends Http implements
    ...
    ResetAfterRequestInterface
{
     ...
     * @param bool $shared
     */
    public function __construct($instanceName = Http::class, $shared = true)
    {
    ...
    protected function _getSubject()
    {
        if (!$this->_subject) {
            ...
            $this->_subject =  new Http(
                $objectManager->get(\Magento\Framework\Stdlib\Cookie\CookieReaderInterface::class),
                $objectManager->get(\Magento\Framework\Stdlib\StringUtils::class),
                $objectManager->get(\Magento\Framework\App\Route\ConfigInterface::class),
                $objectManager->get(\Magento\Framework\App\Request\PathInfoProcessorInterface::class),
                $objectManager,
                null,
                [],
                $objectManager->get(\Magento\Framework\App\Request\PathInfo::class)
            );
        }
