...
class CollectionTest extends TestCase
{
     ...
     */
    public function testGetPurchaseNumber(
        array $customerToStoreMap,
        array $orderCountsByStoreMap,
        int $expectedCnt
    ): void {
        ...
        $this->select
            ->method('where')
            ->willReturnCallback(function ($arg1) use ($expectedCondition) {
                if ($arg1 == [] || $arg1 === $expectedCondition) {
                    return $this->select;
                }
            });
     ...
     * @return array
     */
    public static function getPurchasedNumberDataProvider(): array
    {
        return [
            [
                'customerToStoreMap' => [
