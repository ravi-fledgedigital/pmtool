...
class OrderManagementTest extends TestCase
{
    ...
    public function testProcess(string $email, int $customerId, int $quoteId): void
    {
        ...
        $quote->expects($this->once())->method('getIsActive')->willReturn(1);
    ...
    public function testProcessQuoteWithInitialOrder(): void
    {
        ...
        $quote = $this->getMockBuilder(Quote::class)
            ->disableOriginalConstructor()
            ->addMethods(['setIsActive', 'setOrigOrderId', 'setReservedOrderId'])
        ...
        $order = $this->getMockBuilder(Order::class)
            ->disableOriginalConstructor()
            ->onlyMethods(['getEntityId', 'getIncrementId', 'getStatus'])
            ->getMock();
