...
class ModelLoadAfterObserver implements ObserverInterface
{
    ...
    /**
     * A counter to avoid infinite recursion
     *
     * @var int
     */
    private int $rescursiveDepthCount = 0;
    ...
    {
        if ($this->rescursiveDepthCount) {
            return; // Don't be recursive!
        }
        $this->rescursiveDepthCount += 1;
