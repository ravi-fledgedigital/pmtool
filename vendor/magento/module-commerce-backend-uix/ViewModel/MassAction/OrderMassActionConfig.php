...
/**
 * Order Mass Action Config for view model
 */
class OrderMassActionConfig implements MassActionConfigInterface
{
    /**
    ...
    public function getConfig(string $actionId): array
    {
        ...
        $this->config['redirectUrl'] = $this->escaper->escapeUrl(
            $this->backendUrl->getUrl('adminuisdk/redirect/redirect', [
                'extensionPoint' => 'orderMassAction',
