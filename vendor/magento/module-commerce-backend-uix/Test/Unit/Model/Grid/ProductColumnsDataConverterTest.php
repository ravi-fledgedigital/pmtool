...
/**
 * Unit test class for ProductColumnsDataConverter class
 */
class ProductColumnsDataConverterTest extends TestCase
{
    private const COLUMN_ID = 'test_column';
    private const COLUMN_TYPE = 'string';
    private const ENTITY = 'products';
    private const GRID_COLUMN = 'productGridColumns';
    ...
    {
        $receivedData = '{"data":{"test":{"testproducts":1}}';
