...
class Collection extends \Magento\Framework\Data\Collection
{
     ...
     * @var int
     */
    public const CUSTOMER_ENTITY_FINANCE_ATTRIBUTE_CUSTOMER_BALANCE = 1;

    /**
     * @var int
     */
    public const CUSTOMER_ENTITY_FINANCE_ATTRIBUTE_REWARD_POINTS = 2;

    /**
     * @var string
     */
    public const COLUMN_CUSTOMER_BALANCE = 'store_credit';

    /**
     * @var string
     */
    public const COLUMN_REWARD_POINTS = 'reward_points';
