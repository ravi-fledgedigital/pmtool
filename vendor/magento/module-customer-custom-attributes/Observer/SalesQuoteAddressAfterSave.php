 ...
 */
class SalesQuoteAddressAfterSave implements ObserverInterface, ResetAfterRequestInterface
{
    /**
    ...
    private function getAttributesList()
    {
        if (!$this->attributesList) {
            ...
            $attributesList->addFieldToFilter('frontend_input', ['in' => ['file', 'image', 'multiselect']]);
