...
class NodeOnSimpleProductPageTest extends TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        if (class_exists(\Magento\PaymentServicesPaypal\Observer\AddCheckoutComponents::class)) {
            $mock = $this->createMock(\Magento\PaymentServicesPaypal\Observer\AddCheckoutComponents::class);
            $mock->method('execute')->willReturn(true);
            $this->objectManager
                ->addSharedInstance($mock, \Magento\PaymentServicesPaypal\Observer\AddCheckoutComponents::class);
        }
    }
