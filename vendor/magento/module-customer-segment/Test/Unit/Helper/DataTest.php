...
class DataTest extends TestCase
{
     ...
     */
    public function testAddSegmentFieldsToForm(array $fixtureFormData): void
    {
        ...
        $fieldset
            ...
            ->willReturnCallback(function ($arg1) {
                if ($arg1 === 'use_customer_segment' || $arg1 === 'select') {
                    return null;
                } elseif ($arg1 === 'customer_segment_ids' || $arg1 === 'multiselect') {
                    return null;
                }
            });
        ...
        $dependencies
            ->method('addFieldMap')
            ->willReturnCallback(function ($arg1, $arg2) use ($dependencies) {
                if ($arg1 == 'pfx_use_customer_segment' && $arg2 == 'use_customer_segment') {
                    return $dependencies;
                } elseif ($arg1 == 'pfx_customer_segment_ids' && $arg2 == 'customer_segment_ids') {
                    return $dependencies;
                }
            });
     ...
     * @return array
     */
    public static function addSegmentFieldsToFormDataProvider(): array
    {
        return [
            'all segments' => [[]],
     ...
     * @return void
     */
    public function testAddSegmentFieldsToFormDisabled(): void
    {
        $this->_scopeConfig->expects(
            $this->once()
        )->method(
