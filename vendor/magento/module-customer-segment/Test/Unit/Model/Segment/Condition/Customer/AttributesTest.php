...
class AttributesTest extends TestCase
{
    ...
    public function testGetConditionsSqlBillingShipping(
        ...
        $expression = new \Zend_Db_Expr($expressionString);
    ...
    public function dataProviderGetConditionsSqlOther()
    {
        return [
            ...
            [
                'attribute_code' => 'test with string attribute options',
                'frontend_input' => 'multiselect',
                'is_static' => false,
                'value' => [
                    'argument' => ['vip-group,premium-group'],
                    'expected' => ['vip-group,premium-group'],
                ],
                'operator' => [
                    'argument' => '==',
                    'expected' => 'finset',
