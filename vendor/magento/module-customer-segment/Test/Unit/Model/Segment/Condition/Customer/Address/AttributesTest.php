...
class AttributesTest extends TestCase
{
    ...
    public function testGetConditionsSql(bool $customer, bool $isFiltered, ?bool $isStaticAttribute): void
    {
        if (!$customer && $isFiltered) {
            ...
            if (!$isStaticAttribute) {
                $this->selectMock
                    ->method('where')
                    ->willReturnCallback(function ($arg1, $arg2) use ($condition) {
                        if ($arg1 == "`val`.`attribute_id` = ?" && $arg2 === 1) {
                            return null;
                        } elseif ($arg1 == "`val`.`entity_id` = `customer_address`.`entity_id`") {
                            return null;
                        } elseif ($arg1 == $condition) {
                            return null;
                        }
                    });
                ...
                $this->selectMock
                    ->method('where')
                    ->willReturnCallback(function ($arg1, $arg2) use ($condition) {
                        if ($arg1 == "`val`.`entity_id` = `customer_address`.`entity_id`") {
                            return null;
                        } elseif ($arg1 == $condition) {
                            return null;
                        }
     ...
     * @return array
     */
    public static function getConditionsSqlDataProvider(): array
    {
        return [
            [false, true, null],
            [true, true, true],
