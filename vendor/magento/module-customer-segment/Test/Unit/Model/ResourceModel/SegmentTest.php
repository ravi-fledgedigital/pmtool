...
class SegmentTest extends TestCase
{
     ...
     */
    public function testSaveCustomersFromSelect(): void
    {
        $select =
     ...
     */
    public function testAggregateMatchedCustomers($scope, $websites, $websiteIds): void
    {
        ...
        if ($scope) {
            ...
            $this->_conditions->expects($this->exactly(2))
                ...
                ->willReturnCallback(fn($param) => match ([$param]) {
                    [current($websites)] => $customerIds,
                    [end($websites)] => $customerIds
                });
        }
     ...
     * @return array
     */
    public static function aggregateMatchedCustomersDataProvider(): array
    {
        return [
            [true, [7], [7]],
            [true, [7, 9], [7]],
