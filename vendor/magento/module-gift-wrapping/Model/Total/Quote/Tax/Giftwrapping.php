...
class Giftwrapping extends AbstractTotal
{
     ...
     */
    public const ITEM_TYPE = 'item_gw';

    /**
     * Constant for quote gift wrapping item type
     */
    public const QUOTE_TYPE = 'quote_gw';

    /**
     * Constant for item print card item type
     */
    public const PRINTED_CARD_TYPE = 'printed_card_gw';

    /**
     * Constant for item gift wrapping code prefix
     */
    public const CODE_ITEM_GW_PREFIX = 'item_gw';

    /**
     * Constant for quote gift wrapping code
     */
    public const CODE_QUOTE_GW = 'quote_gw';

    /**
     * Constant for printed card code
     */
    public const CODE_PRINTED_CARD = 'printed_card_gw';

    /**
     * @var \Magento\Quote\Model\Quote|\Magento\Quote\Model\Quote\Address|null
     */
