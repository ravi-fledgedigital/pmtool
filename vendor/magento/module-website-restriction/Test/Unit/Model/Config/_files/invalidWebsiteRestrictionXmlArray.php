...
return [
    ...
    'action_with_same_paths_value' => [
        ...
        [
            "Element 'action': Duplicate key-sequence ['some_path_name'] in unique identity-constraint " .
            "'uniqueActionPath'.\nLine: 1\nThe xml was: \n0:<?xml version=\"1.0\"?>\n1:<config><action " .
            "path=\"some_path_name\" type=\"register\"/><action path=\"some_path_name\" type=\"register\"/>" .
            "</config>\n2:\n"
        ],
    ],
    'action_with_notallowed_attribute' => [
        ...
        [
            ...
            "The xml was: \n0:<?xml version=\"1.0\"?>\n1:<config><action path=\"some_path_name\" " .
            "type=\"register\" notallowed=\"test\"/></config>\n2:\n"
        ],
    ],
    'action_without_required_path_attribute' => [
        ...
        [
            ...
            "0:<?xml version=\"1.0\"?>\n1:<config><action type=\"register\"/></config>\n2:\n"
        ],
    ],
    'action_without_required_type_attribute' => [
        ...
        [
            ...
            "0:<?xml version=\"1.0\"?>\n1:<config><action path=\"some_path_name\"/></config>\n2:\n"
        ],
    ],
    'action_path_invalid_value' => [
        ...
        [
            ...
            "pattern '[a-zA-Z_]+'.\nLine: 1\nThe xml was: \n0:<?xml version=\"1.0\"?>\n" .
            "1:<config><action path=\"1234\" type=\"register\"/></config>\n2:\n"
        ],
    ],
    ...
    'action_type_invalid_value' => [
        ...
        [
            ...
            "1:<config><action path=\"some_path_name\" type=\"invalidvalue\"/></config>\n2:\n"
        ],
    ]
];
