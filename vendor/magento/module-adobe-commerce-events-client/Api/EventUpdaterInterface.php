...
/**
 * Event subscription updater interface
 *
 * @api
 */
interface EventUpdaterInterface
{
    /**
     ...
     */
    public function update(\Magento\AdobeCommerceEventsClient\Api\Data\EventDataInterface $event): void;
}
