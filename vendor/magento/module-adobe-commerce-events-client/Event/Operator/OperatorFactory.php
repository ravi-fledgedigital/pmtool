...
{
    /**
     * @var OperatorInterface|CustomOperatorInterface[]
     */
     ...
     * @return OperatorInterface|CustomOperatorInterface
     * @throws OperatorException
     */
    public function create(string $operatorName): OperatorInterface|CustomOperatorInterface
    {
