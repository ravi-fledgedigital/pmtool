...
class Collection
{
    ...
    public function aroundSetValidationFilter(
        ...
        if (($couponCode !== null && strlen($couponCode))
            ...
            return $proceed($websiteId, $customerGroupId, $couponCode, $now, $address, $couponCodes);
        }

        /** @var RuleCollection $result */
        $result = $proceed($websiteId, $customerGroupId, $couponCode, $now, $address, $couponCodes);
