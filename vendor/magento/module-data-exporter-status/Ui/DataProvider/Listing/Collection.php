...
class Collection extends SearchResult
{
     ...
     * @param IndexerStatusProvider $indexerStatusProvider
    ...
    /**
     * Get status filter value from request
     *
    ...
    public function getData()
    {
        try {
            ...
            $this->_logger->error(
                'Error retrieving feed status data for the Feed Submission Status greed: ' . $e->getMessage(),
                [
                    'exception' => $e,
            ...
            throw  new \RuntimeException(
                'An error occurred while loading the feed status data. Please check the logs for more details.'
            );
        }
    }

    /**
     * Get phrase for unrecognized status code
     *
