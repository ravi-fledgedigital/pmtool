...
class FeedStatusInfo extends Section
{
    ...
    private ?IndexerStatus $indexerStatus = null;

    /**
     * @param Context $context
     * @param FeedPool $feedPool
     * @param IndexerStatusProvider $indexerStatusProvider
     * @param FeedOptionsDataProvider $feedOptionsDataProvider
     * @param array $data
     */
     ...
     */
    public function getIndexerStatus(): ?IndexerStatus
    {
    ...
    /**
     * Check if indexer is in schedule mode
     */
    ...
    /**
     * Get last updated timestamp of changelog
     */
