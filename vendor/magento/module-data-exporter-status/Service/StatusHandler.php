...
class StatusHandler
{
    ...
    /**
     * Map feed item status to UI status
     *
     * @param int $status
     * @return string
     */
    ...
    /**
     * Apply filter to select based on UI status
     *
     * @param string $status
     * @param Select $select
     * @return void
    ...
    /**
     * Check if status is failed status
     *
     * @param int $status
     * @return bool
     */
