...
class FeedIndexStatus
{
    ...
    /**
     * Gets export status query instance
     *
     * @return ExportStatusQueryInterface|null
     */
    private function getExportStatusQuery(): ?ExportStatusQueryInterface
    {
        return $this->feedStatusConfig[$this->feedIndexMetadata->getFeedName()][self::CONFIG_PATH_QUERY_INSTANCE]
            ?? null;
    }
}
