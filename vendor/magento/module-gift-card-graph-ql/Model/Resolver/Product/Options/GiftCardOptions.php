...
class GiftCardOptions implements ResolverInterface
{
    ...
    /**
     * Get Name Options Data
     *
     * @return array|array[]
     */
    private function getNameOptions(): array
    {
        return [
            [
