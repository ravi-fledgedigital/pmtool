...
class ControllersTest extends TestCase
{
     ...
     * @return array
     */
    public static function validateRuleEntityActionGetValidModuleClassNameDataProvider(): array
    {
        return [
     ...
     * @return array
     */
    public static function validateCmsHierarchyActionDataProvider(): array
    {
        return [
            [[], true, true, 'getActionNameInvoke' => self::never()],
            [[], false, false, 'getActionNameInvoke' => self::atLeastOnce()],
            [['website' => 1, 'store' => 1], false, false, 'getActionNameInvoke' => self::atLeastOnce()],
            [['store' => 2], false, true, 'getActionNameInvoke' => self::never()],
            [['store' => 1], false, false, 'getActionNameInvoke' => self::atLeastOnce()]
        ];
    }
     ...
     * @return array
     */
    public static function validateGiftCardAccountDataProvider(): array
    {
        return [
            'WithWebsiteLevelPermissions' => [
                ...
                'action' => '',
                'id' => null,
                'expectedInvoke' => self::never(),
                'getActionNameInvoke' => self::never()
            ],
            'WithoutWebsiteLevelPermissionsActionNew' => [
                'isWebSiteLevel' => false,
                'action' => Ctrl::ACTION_NEW,
                'id' => null,
                'expectedInvoke' => self::atLeastOnce(),
                'getActionNameInvoke' => self::atLeastOnce()
            ],
     ...
     * @return array
     */
    public static function validateGiftregistryEntityActionDataProvider(): array
    {
        $id = 1;
        $websiteId = 1;
        return [
            'withoutId' => [
                ...
                'roleWebsiteIds' => [],
                'expectedInvoke' => self::never(),
                'expectedForwardInvoke' => self::never(),
                'getActionNameInvoke' => self::atLeastOnce(),
                'expectedValue' => false
            ],
            'withIdNotInRoleIds' => [
     ...
     * @return array
     */
    public static function validateCustomerAttributeActionsDataProvider(): array
    {
        return [
            'actionNew' => [
     ...
     * @return array
     */
    public static function validateCustomerEditDataProvider(): array
    {
        $id = 1;
        $websiteId = 1;
        return [
     ...
     * @return array
     */
    public static function validateCustomerbalanceDataProvider(): array
    {
        $id = 1;
        $websiteId = 1;
        return [
     ...
     * @return array
     */
    public static function validateCatalogProductMassActionsDataProvider(): array
    {
        return [
            'hasStoreAccess' => [
                'hasStoreAccess' => true,
     ...
     * @return array
     */
    public static function validateCatalogProductAttributeActionsDataProvider(): array
    {
        return [
     ...
     * @return array
     */
    public static function validateCatalogProductAttributeCreateActionDataProvider(): array
    {
        $attributeId = 1;
        return [
     ...
     * @return array
     */
    public static function validateCatalogProductReviewDataProvider(): array
    {
        $reviewId = 1;
        return [
            'allowIfReviewHasAccess' => [
                ...
                'reviewStoreIds' => [1],
                'storeIds' => [1, 2, 3],
                'expectedRedirectInvoke' => self::never()
            ],
            'redirectIfReviewHasNoAccess' => [
                'reviewId' => $reviewId,
                'reviewStoreIds' => [1],
                'storeIds' => [2, 3],
                'expectedRedirectInvoke' => self::once()
            ]
        ];
    }
     ...
     * @return array
     */
    public static function validateCatalogProductEditDataProvider(): array
    {
        $storeId = 1;
        return [
     ...
     * @return array
     */
    public static function validateCatalogEventsDataProvider(): array
    {
        return [
            ...
            'forwardIfActionNameIsNewWithoutCategory' => [
                ...
                'allowedRootCategories' => null,
                'categoryPath' => null,
                'expectedForwardInvoke' => self::atLeastOnce()
            ],
     ...
     * @return array
     */
    public static function validateCatalogEventEditDataProvider(): array
    {
        $storeId = 1;
        return [
            'allow' => [
     ...
     * @return array
     */
    public static function validateCatalogCategoriesAddDataProvider(): array
    {
        return [
     ...
     * @return array
     */
    public static function validateCatalogCategoriesEditDataProvider(): array
    {
        return [
            'allowIfNotAddAndEdit' => [
                'actionName' => Ctrl::ACTION_DELETE,
     ...
     * @return array
     */
    public static function validateSalesOrderDataProvider(): array
    {
        return [
            'hasStoreAccess' => [
                'hasStoreAccess' => true,
    ...
    public function testValidateSalesOrderShipmentTrackActionHasStoreAccess(): void
    {
        ...
        $this->_objectManager
            ->method('create')
            ->willReturnCallback(fn($param) => match ([$param]) {
                [Track::class] => $orderShipmentTrackMock,
                [Shipment::class] => $orderShipmentMock
            });
     ...
     * @return array
     */
    public static function validateCheckoutAgreementEditActionDataProvider(): array
    {
        return [
            'hasStoreAccess' => [
                'hasStoreAccess' => true,
     ...
     * @return array
     */
    public static function validateActionsDataProvider(): array
    {
        return [
            'hasStoreAccess' => [
                'hasStoreAccess' => true,
     ...
     * @return array
     */
    public static function validateNoWebsiteGenericDataProvider(): array
    {
        return [
            'hasStoreAccess' => [
