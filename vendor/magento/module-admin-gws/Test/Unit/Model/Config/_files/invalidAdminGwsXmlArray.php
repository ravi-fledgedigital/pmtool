...
return [
    'callback_class_must_be_unique' => [
        ...
        [
            ...
            "'uniqueCallbackClass'.\nLine: 1\nThe xml was: \n0:<?xml version=\"1.0\"?>\n1:<config><group " .
            "name=\"collection_load_before\" processor=\"c\"><callback class=\"class_one\" " .
            "method=\"methodOne\"/><callback class=\"class_one\" method=\"methodTwo\"/></group></config>\n2:\n"
        ],
    ],
    'missed_group_processor' => [
        ...
        [
            ...
            "0:<?xml version=\"1.0\"?>\n1:<config><group name=\"collection_load_before\"><callback " .
            "class=\"class_one\" method=\"methodOne\"/></group></config>\n2:\n"
        ],
    ],
    'level_name_must_be_unique' => [
        ...
        [
            "Element 'level': Duplicate key-sequence ['name_one'] in unique identity-constraint 'uniqueLevelName'.\n" .
            "Line: 1\nThe xml was: \n0:<?xml version=\"1.0\"?>\n1:<config><aclDeny><level name=\"name_one\"><rule" .
            " name=\"name_one\" resource=\"One::Two\"/></level><level name=\"name_one\"><rule name=\"name_two\" " .
    ...
    'level_without_rules' => [
        ...
        [
            ...
            "0:<?xml version=\"1.0\"?>\n1:<config><aclDeny><level name=\"name_two\"/></aclDeny></config>\n2:\n"
        ],
    ],
    'rule_name_must_be_unique' => [
        ...
        [
            ...
            "'uniqueRuleName'.\nLine: 1\nThe xml was: \n0:<?xml version=\"1.0\"?>\n1:<config><aclDeny><level " .
            "name=\"name_one\"><rule name=\"name_one\" resource=\"One::Two\"/></level><level name=\"name_two\">" .
            "<rule name=\"name_one\" resource=\"One::Three\"/><rule name=\"name_one\" resource=\"One::Three\"/>" .
            "</level></aclDeny></config>\n2:\n"
        ],
    ],
    'group_name_must_be_unique' => [
        ...
        [
            ...
            "'uniqueGroupName'.\nLine: 1\nThe xml was: \n0:<?xml version=\"1.0\"?>\n1:<config><group " .
            "name=\"collection_load_before\" processor=\"c\"><callback class=\"class_one\" " .
            "method=\"methodOne\"/><callback class=\"class_two\" method=\"methodTwo\"/></group><group " .
            "name=\"collection_load_before\" processor=\"c\"><callback class=\"class_two\" " .
            "method=\"methodOne\"/></group></config>\n2:\n"
        ],
    ],
    'group_name_is_required' => [
        ...
        [
            ...
            "0:<?xml version=\"1.0\"?>\n1:<config><group processor=\"c\"><callback class=\"class_one\" " .
            "method=\"methodOne\"/></group></config>\n2:\n"
        ],
    ],
    'callback_method_and_class_are_required' => [
        ...
        [
            ...
            "0:<?xml version=\"1.0\"?>\n1:<config><group name=\"name\" processor=\"c\"><callback " .
            "class=\"class_one\"/><callback method=\"method\"/></group></config>\n2:\n",
    ...
    'level_has_required_attribute_name' => [
        ...
        [
            ...
            "0:<?xml version=\"1.0\"?>\n1:<config><aclDeny><level><rule name=\"name_one\" " .
            "resource=\"One::Two\"/></level><level name=\"name_two\"><rule name=\"name_two\" " .
            "resource=\"One::Three\"/><rule name=\"name_one\" resource=\"One::Three\"/></level></aclDeny>" .
            "</config>\n2:\n"
        ],
    ],
    'rule_has_required_attributes_name_and_resource' => [
        ...
        [
            ...
            "0:<?xml version=\"1.0\"?>\n1:<config><aclDeny><level name=\"name_one\"><rule/></level><level " .
            "name=\"name_two\"><rule name=\"name_two\" resource=\"One::Three\"/><rule name=\"name_one\" " .
            "resource=\"One::Three\"/></level></aclDeny></config>\n2:\n",
    ...
    'resource_with_invalid_value' => [
        ...
        'resource="One:Three"/></level></aclDeny></config>',
        [
            "Element 'rule', attribute 'resource': [facet 'pattern'] The value 'One/Three' is not accepted by " .
            "the pattern '[a-zA-Z_:]+'.\nLine: 1\nThe xml was: \n0:<?xml version=\"1.0\"?>\n1:<config><aclDeny>" .
            "<level name=\"name_one\"><rule name=\"name_two\" resource=\"One::Three\"/></level><level " .
            "name=\"name_two\"><rule name=\"name_two\" resource=\"One/Three\"/><rule name=\"name_one\" " .
            "resource=\"One:Three\"/></level></aclDeny></config>\n2:\n"
        ],
    ],
    'method_with_invalid_value' => [
        ...
        [
            "Element 'callback', attribute 'method': [facet 'pattern'] The value 'method12' is not accepted " .
            "by the pattern '[a-zA-Z]+'.\nLine: 1\nThe xml was: \n0:<?xml version=\"1.0\"?>\n1:<config><group " .
            "name=\"collection_load_before\" processor=\"c\"><callback class=\"class_one\" method=\"method12\"/>" .
            "<callback class=\"class_two\" method=\"methodTwo\"/></group></config>\n2:\n"
        ],
    ]
];
