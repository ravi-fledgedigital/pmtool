...
class ModelsTest extends TestCase
{
    ...
    public function testCmsPageSaveBefore()
    {
        ...
        $cmsPage = $this->getMockBuilder(\Magento\Cms\Model\Page::class)
            ->disableOriginalConstructor()
            ->addMethods(['getStoreId', 'setStoreId'])
            ->onlyMethods(['getResource', 'getId'])
            ->getMock();
    ...
    public function testRuleSaveBefore(
        ...
        $catalogRuleResource = $this->getMockBuilder(Rule::class)
            ->disableOriginalConstructor()
            ->addMethods(['getId', 'isObjectNew', 'getData', 'getOrigData'])
            ->getMock();
     ...
     * @return array
     */
    public static function ruleSaveBeforeDataProvider(): array
    {
