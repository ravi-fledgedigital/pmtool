...
/**
 * Unit Test for Admin Controller Pre Dispatch
 *
...
*/
    ...
    public function testAdminControllerPredispatchGwsIsNotAll(): void
    {
        ...
        $this->rolePermissionAssigner
            ...
            ->willReturnCallback(
                function ($arg1) {
                    if ($arg1 === $this->adminControllerPredispatchObserver::ACL_WEBSITE_LEVEL
                        && $arg1 === $this->adminControllerPredispatchObserver::ACL_STORE_LEVEL) {
                        return $this->rolePermissionAssigner;
                    }
                }
            );
