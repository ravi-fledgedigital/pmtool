...
*/
        $elementMock = $this->getMockBuilder(AbstractElement::class)
            ->addMethods(['getValue', 'setValue', 'setValueClass'])
            ->onlyMethods(['getId', 'getData', 'getForm', 'setData'])
            ->disableOriginalConstructor()
        ...
        $elementMock->expects($this->any())
            ->method('setData')
            ->willReturnCallback(
                function ($arg1, $arg2) use ($hiddenHtml, $toHtmlValue) {
                    if ($arg1 == 'css_class' && $arg2 == 'grid-chooser') {
                        return $this;
                    } elseif ($arg1 == 'after_element_html' && $arg2 == $hiddenHtml . $toHtmlValue) {
                        return $this;
                    } elseif ($arg1 == 'no_wrap_as_addon' && $arg2 === true) {
                        return $this;
                    }
                }
            );
