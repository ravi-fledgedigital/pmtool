...
class DataTest extends TestCase
{
    ...
    /**
     * @var BannersByStore|MockObject
     */
    private $bannersByStore;
    ...
    protected function setUp(): void
    {
        ...
        $this->bannersByStore = $this->createMock(BannersByStore::class);
        ...
        $this->unit = $helper->getObject(
            ...
            [
                ...
                'bannersByStore' => $this->bannersByStore
            ]
        );
    }
    ...
    public function testGetBannersContentFixed()
    {
        ...
        $banner = ['id' => 123, 'content' => 'Fixed Dynamic Block 123', 'types' => ['footer']];

        $this->bannersByStore->expects($this->any())
            ->method('execute')
            ->with([123], self::STORE_ID)
            ->willReturn([[123 => $banner], []]);
    ...
    public function testGetBannersContentCatalogRule()
    {
        ...
        $banner = ['id' => 123, 'content' => 'CatalogRule Dynamic Block 123', 'types' => ['footer']];
    ...
    public function testGetBannersContentSalesRule()
    {
        ...
        $banner = ['id' => 123, 'content' => 'SalesRule Dynamic Block 123', 'types' => ['footer']];
