    ...
    public function testAfterSave()
    {
        ...
        $this->session->expects($this->any())
            ...
            ->willReturnCallback(function ($arg1, $arg2) {
                if ($arg1 == 'googleanalytics_creditmemo_order' && $arg2 == '00000001') {
                    return $this->session;
                } elseif ($arg1 == 'googleanalytics_creditmemo_store_id' && $arg2 == 2) {
                    return $this->session;
                } elseif ($arg1 == 'googleanalytics_creditmemo_revenue' && $arg2 == '19.99') {
                    return $this->session;
                } elseif ($arg1 == 'googleanalytics_creditmemo_products' && $arg2 == [
                        [
                            'id' => 'Item 1',
                            'quantity' => 3
                        ]
