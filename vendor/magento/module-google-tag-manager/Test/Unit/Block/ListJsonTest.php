...
class ListJsonTest extends TestCase
{
    ...
    public function testGetCartContent()
    {
        ...
        $item1->expects($this->atLeastOnce())->method('getSku')->willReturn('SKU12323');
        $item1->expects($this->atLeastOnce())->method('getName')->willReturn('Product Name');
        $item1->expects($this->atLeastOnce())->method('getPrice')->willReturn(116);
        $item1->expects($this->atLeastOnce())->method('getQty')->willReturn(2);

        $item2 = $this->createMock(Item::class);
        $item2->expects($this->atLeastOnce())->method('getSku')->willReturn('SKU12324');
        $item2->expects($this->atLeastOnce())->method('getName')->willReturn('Product Name 2');
        $item2->expects($this->atLeastOnce())->method('getPrice')->willReturn(100);
        $item2->expects($this->atLeastOnce())->method('getQty')->willReturn(2.5);

        $quote = $this->createMock(Quote::class);
        $quote->expects($this->atLeastOnce())->method('getAllVisibleItems')->willReturn([$item1, $item2]);
        ...
        $this->jsonHelper->expects($this->once())->method('jsonEncode')->with($json)->willReturn(json_encode($json));
        $finalResult = $this->listJson->getCartContent();
        $this->assertEquals(json_encode($json), $finalResult);
        $this->assertStringNotContainsString('"price":"116"', $finalResult);
        $this->assertStringNotContainsString('"quantity":"2"', $finalResult);
        $this->assertStringContainsString('"price":116', $finalResult);
        $this->assertStringContainsString('"qty":2', $finalResult);
    }
    ...
    public function testGetCartContentForUpdate()
    {
        ...
        $item1->expects($this->atLeastOnce())->method('getSku')->willReturn('SKU12323');
        $item1->expects($this->atLeastOnce())->method('getName')->willReturn('Product Name');
        $item1->expects($this->atLeastOnce())->method('getPrice')->willReturn(116.50);
        $item1->expects($this->atLeastOnce())->method('getQty')->willReturn(2);
        ...
        $this->jsonHelper->expects($this->once())->method('jsonEncode')->with($json)->willReturn(json_encode($json));
        $this->assertEquals(json_encode($json), $this->listJson->getCartContentForUpdate());
    }
}
